...
test('buttons', async({page}) => {
    ...
    await page.goto('https://letcode.in/button')
    const position = await page.locator('#position').boundingBox().then(box => {console.log(box.x, box.y)});
    ...
    await page.locator('#property').boundingBox().then(box => {console.log(box.height, box.width)});
